...
<a class="btn_menu" href="game.php?page=PTrader">{$LNG.alm_adv_trader}</a>
<a class="btn_menu" href="game.php?page=academy">Academy {if $academy_reduce != 0}<span style="color:#FC0;">-{$academy_reduce}%</span>{/if}</a>	
...
<a class="btn_menu"  href="game.php?page=Planeta">Planet Auctions</a>
<a class="btn_menu" href="game.php?page=Reward2">Redeem</a>
<a class="btn_menu" href="game.php?page=FleetDealer">Fleet Dealer</a>
...
<br><span style=' margin-left: 9px; margin-right: 4px; cursor: default; float: left;'>•</span>points Academy <b>1-25</b>
<br><span style=' margin-left: 9px; margin-right: 4px; cursor: default; float: left;'>•</span>peaceful experience <b>150-3500</b>
<br><span style=' margin-left: 9px; margin-right: 4px; cursor: default; float: left;'>•</span>bonus antimatter <b>200</b>
